...
import { Auth0OidcBaseOptions, Auth0OidcOptions } from 'src/interfaces/auth0-oidc-module-options.interface';
...
export class Auth0OidcAuthMiddleware implements NestMiddleware {
  public constructor(
    ...
    @Inject('BASE_OPTIONS') private readonly baseOptions: Auth0OidcBaseOptions,
    @Inject('OPTIONS') private readonly options: Auth0OidcOptions
  ) {}
